...
DbMongo.prototype.findAndModify = function findAndModify (collection) {
  ...
  // If object being set has {_update:..}, then use that as an update operation to save on batch sets
  if (args[0]._id && args[2] && args[2]['$set'] && args[2]['$set']['update__']) {
    args[2] = {'$set': args[2]['$set']['update__']};
  }
  //console.log(args)
